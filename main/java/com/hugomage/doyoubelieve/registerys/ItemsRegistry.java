...
public class ItemsRegistry {
    ...
    public static final RegistryObject<ModSpawnEggItem> FRESNO_NIGHTCRAWLER_SPAWN_EGG = ITEMS.register("fresno_nightcrawler_spawn_egg",() -> new ModSpawnEggItem(ModEntityTypes.FRESNO, 0x702817, 0x5E4944 , new Item.Properties().tab(ItemGroup.TAB_MATERIALS)));
